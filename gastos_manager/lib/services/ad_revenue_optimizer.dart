...
/// Classe para rastrear dados de desempenho de anúncios
class AdPerformanceData {
  ...
  /// Ganho por mil impressões (eCPM) em dólares
  double get ecpm => impressions > 0 ? (revenue / impressions) * 1000 : 0.0;
}

/// Otimizador de receita de anúncios com rastreamento de desempenho
class AdRevenueOptimizer {
  ...
  /// Carregar anúncio com recompensa
  void loadRewardedAd() {
  ...
  /// Obter dados de desempenho de todos os anúncios
  Map<String, AdPerformanceData> getPerformanceData() {
    return Map.unmodifiable(_performanceData);
  }

  /// Obter estatísticas de desempenho dos anúncios
  ...
  /// Criar anúncio de banner otimizado
  ...
  /// Criar anúncio intersticial otimizado
  ...
  /// Criar anúncio com recompensa otimizado
  ...
  /// Obter próximo ID de banner (para rotação)
