    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!_adicionarDesbloqueado && !FORCE_PREMIUM)
            Container(
              padding: const EdgeInsets.all(16),
              ...
              child: Column(
                children: [
                  const Icon(Icons.lock_open, color: Colors.blue, size: 32),
                  const SizedBox(height: 8),
                  const Text('Recurso Premium Liberado!'),
                  const SizedBox(height: 8),
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
                    ...
                    child: const Text('Usar Gratuitamente'),
                  ),
                ],
              ),
            ),
