    ...
    return Consumer<ThemeService>(
      builder: (context, themeService, child) {
        final listViewContent = ListView(
          ...
          children: [
            // Seção Feedback sobre anúncios
            _buildSectionHeader('Anúncios', Icons.campaign),
            const SizedBox(height: 8),
            ListTile(
              leading: const Icon(Icons.feedback, color: Colors.orange),
              title: const Text('Enviar feedback sobre anúncios'),
              subtitle:
                  const Text('Ajude-nos a melhorar a experiência de anúncios'),
              onTap: () async {
                final result = await showDialog<String>(
                  context: context,
                  builder: (context) => AlertDialog(
                    title: const Text('Feedback sobre anúncios'),
                    content: const TextField(
                      maxLines: 4,
                      decoration: InputDecoration(
                        hintText: 'Descreva sua experiência com os anúncios...',
                    ...
                    actions: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          // Aqui você pode integrar com analytics, backend, etc.
